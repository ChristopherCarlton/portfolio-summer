...
export default function resume() {
  return (
    <div className="bg-white text-black max-w-[800px] mx-auto p-8 shadow-lg">
      ...
      <ul className="mb-6 list-disc pl-5">
        ...
        <li>
          Islander Sports Foundation Award for Integrity, Sportsmanship, and
          Friendship - 2016
        </li>
      ...
      <ul className="mb-6 list-disc pl-5">
        ...
        <li>
          Coronado HS Girls Tennis Fundraiser - 2018. Each participant had a
          monetary goal by sharing via social media or directly asking for
          donations.
        </li>
        <li>Varsity Girls Tennis Team - 2015, 2016, 2017, 2018 (Captain)</li>
        <li>
          Entrepreneur: Owner of PresetsBySummer on Etsy. I have ratings of 5
          stars with 950 current sales. I market my own products through my own
          social media accounts on Instagram and Tik Tok
        </li>
      ...
      <ul className="list-disc pl-5">
        <li>
          Grace Church - Sunday school volunteer for children - 2015, 2016
        </li>
